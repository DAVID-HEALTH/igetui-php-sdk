...
use IGetui\protobuf\encoding\base128varint;
...
abstract class PBMessage
{
     ...
     *
     * @param
     *            message as stream of hex example '1a 03 08 96 01'
     */
     ...
     *            the url
     * @param
     *            the PBMessage class where the request should be encoded
     *
